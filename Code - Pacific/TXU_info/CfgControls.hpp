...
class TXU_TS_INFOBUTTON1 : TXU_GUI_RscButton
{
	...
	//url= "ts3server://teamspeak.zeus-community.net?port=9987";
	url="https://discord.gg/c2nECKy9PF";
	w = 0.5;
	colorText[] = {0,1,1,1};
	colorDisabled[] = {1,1,1,0.25};
...
{
	//url = "https://forums.bohemia.net/forums/topic/169501-link-to-website-in-briefing/";
	//url = "https://zeus-community.net";
	text = "Visit our website";
	url= "https://zeus-community.net/a3/";
};

class TXU_TS_INFOBUTTON4 : TXU_TS_INFOBUTTON1
{
	text = "Download ZClient";
	url= "http://zclient.zeus-community.net";
};